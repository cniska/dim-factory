...
2. **Was this already decided?** `dim q search "<the question, in your words>"` ranks the text a person distilled by hand — handoff Nexts, their own commit subjects — by meaning, falling back to keywords. A decision already taken is not yours to re-take; find it and say what it settled.
