...
| `search "<question>"` | distilled passages closest in meaning: score, kind, when, ref, where, excerpt — where a ref is a commit sha or `<session>@<ts>`, and falls back to the keyword index |
