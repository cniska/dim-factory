...
- **Parallel work.** The planner identifies ready items whose dependencies are satisfied. Grouping them into independent isolated jobs, claims and landing remain driver responsibilities.
